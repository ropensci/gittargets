...
How poorly does `targit` perform? To find out, we recommend you use the [`proffer`](https://github.com/r-prof/proffer) package and take screenshots of the results displayed in your browser.

```r
library(targit)
library(proffer)
px <- pprof({
  # All your targit code goes here.
})
```
