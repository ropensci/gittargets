...
You will also need command line Git, available at <https://git-scm.com/downloads>. Please make sure Git is reachable from your system path environment variables. The following R code should run without error if Git is ready to use.
